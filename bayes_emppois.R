...
write.table(MTD_titecrmmc, file="scenario1poisempbayes.txt")
write.table(MTD_titecrmmc24, file="scenario1poisemp24bayes.txt")
write.table(MTD_titecrmmc32, file="scenario1poisemp32bayes.txt")

write.table(doses_titecrmmc, file="scenario1poisempbayes_doses.txt")
write.table(tox_titecrmmc, file="scenario1poisempbayes_tox.txt")
