...
write.table(MTD_titecrmmc, file="scenario1fixprobbayes.txt")
write.table(MTD_titecrmmc24, file="scenario1fixprob24bayes.txt")
write.table(MTD_titecrmmc32, file="scenario1fixprob32bayes.txt")

write.table(doses_titecrmmc, file="scenario1fixprobbayes_doses.txt")
write.table(tox_titecrmmc, file="scenario1fixprobbayes_tox.txt")
