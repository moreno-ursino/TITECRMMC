...
library(rstan)
sm <- stan_model(file="empiric_stan2.stan", model_name='emp2',verbose=FALSE)
...
write.table(MTD_titecrmmc, file="scenario1fixempbayes.txt")
write.table(MTD_titecrmmc24, file="scenario1fixemp24bayes.txt")
write.table(MTD_titecrmmc32, file="scenario1fixemp32bayes.txt")

write.table(doses_titecrmmc, file="scenario1fixempbayes_doses.txt")
write.table(tox_titecrmmc, file="scenario1fixempbayes_tox.txt")
